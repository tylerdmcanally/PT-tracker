...
- A Monday–Sunday skill-dose rule with the standalone microdose as the sole optional extra in program v1.4.9 while historical v1.3 Day 3 bundles remain compatible
...
The active primary program is **AFT Foundation Block 1 v1.4.9**, effective August 28, 2026. Day 3 advances Romanian deadlift to 135 lb total for 2 × 8; goblet squat to 55 lb for 3 × 10; incline dumbbell press to 35 lb per hand for 3 × 8; one-arm dumbbell row to 45 lb for 3 × 12 per side; body-weight split squat to 2 × 12 per leg; side plank to 3 × 45 seconds per side; hammer curl to 25 lb per hand for 2 × 10; and overhead cable triceps to the next comparable increment above 88 lb for 2 × 10–12. Days 1, 2, and 4, the four-day rotation, Stage 4, the two-round conditioning circuit, and the skill microdose remain unchanged.
