...
- A Monday–Sunday skill-dose rule with the standalone microdose as the sole optional extra in program v1.4.6 while historical v1.3 Day 3 bundles remain compatible
...
The active primary program is **AFT Foundation Block 1 v1.4.6**, effective August 23, 2026. Days 1–3 retain all v1.4.5 strength prescriptions. Coach-directed running advances to Stage 4—1:00 walking followed by 2:30 running for six rounds—on Days 1 and 4. Day 4 hand-release push-ups advance to 4 × 8 at target RPE 5–7, and front planks advance to 3 × 45 seconds at target RPE 6–8. Day 4 mobility remains 5–10 minutes. The four-day rotation, two-round conditioning circuit, and skill microdose remain unchanged.
...
The separately versioned **AFT Skill Microdose v1.0** is available at most once per Monday–Sunday week under normal use. It adds low-fatigue hand-release push-up and front-plank practice without advancing the primary rotation or changing the coach-directed run stage. It is the sole optional extra push-up/plank practice in program v1.4.6; historical v1.3 Day 3 skill bundles continue to retain their original weekly-dose behavior. Completed microdose reps and front-plank seconds count only as AFT-event practice volume, never as benchmark results.

Run progression is coach-directed rather than automatically advanced. Program v1.4.6 uses Stage 4—one minute walking followed by two minutes thirty seconds running for six rounds, totaling 21 programmed minutes—on Days 1 and 4. The post-strength Day 1 run begins around 6.0–6.2 mph, while the fresh-leg Day 4 run uses approximately 6.2–6.4 mph. Both target RPE 5–6 and prioritize longer continuous-running segments over speed or average pace. The timer starts every interval round with walking, automatically logs completed rounds and programmed interval time, and marks the run exercise done. Total elapsed time remains a separate user-entered value and is not used to judge structured interval adherence.
