...
- A Monday–Sunday skill-dose rule with the standalone microdose as the sole optional extra in program v1.4.5 while historical v1.3 Day 3 bundles remain compatible
...
The active primary program is **AFT Foundation Block 1 v1.4.5**, effective August 21, 2026. Days 1, 2, and 4 remain unchanged from v1.4.4. Day 3 advances the Romanian deadlift to 125 lb for 2 × 8, goblet squat to 55 lb for 3 × 9, incline dumbbell press to 30 lb per hand for 3 × 10, one-arm dumbbell row to 45 lb for 3 × 11 per side, body-weight split squat to 2 × 10 per leg, and side plank to 3 × 40 seconds per side. Hammer curls use the corrected 20 lb-per-hand working load for 2 × 15, and the same rope/cable triceps setup uses 88 lb for 2 × 15. The two-round conditioning circuit, Stage 3, and the skill microdose remain unchanged.
