...
- A Monday–Sunday skill-dose rule with the standalone microdose as the sole optional extra in program v1.4.8 while historical v1.3 Day 3 bundles remain compatible
...
The active primary program is **AFT Foundation Block 1 v1.4.8**, effective August 26, 2026. Day 2 advances hand-release push-ups to 5 × 9; seated lat pulldown to the next increment above 154 lb for 3 × 8–10; seated dumbbell overhead press to 30 lb per hand for 3 × 8; machine row to the next increment above 88 lb for 3 × 8–10; the same cable lateral-raise setup to 2 × 18; and the next pec-deck increment above 66 lb for 2 × 12. Machine-stack numbers remain setup-specific guidance. Dead bug and 25–30 minutes of easy cardio remain unchanged, as do Days 1, 3, and 4, the four-day rotation, Stage 4, the two-round conditioning circuit, and the skill microdose.
