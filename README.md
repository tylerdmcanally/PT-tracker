...
- Four active primary workout days, historical compatibility for the retired v1.5.5 Day 1 illness-recovery session, and separate optional recovery and AFT Skill Microdose sessions
...
- Automatic Day 1 → Day 4 rotation that maps the saved historical illness-recovery session to Day 1 and ignores recovery and skill-microdose sessions
...
- A Monday–Sunday skill-dose rule with the standalone microdose as the sole optional extra in program v1.5.7 while historical v1.3 Day 3 bundles remain compatible
...
Historical version 1.3 snapshots retain the original four-component circuit and any saved one-occurrence sled directive. Versions 1.4 through 1.4.4 use a 115 lb total Romanian-deadlift target for 2 × 8 and the original sled-enhanced `foundation-1.4` circuit. Versions 1.4.5 through 1.4.8 use 125 lb for 2 × 8 and a separately versioned circuit template for the known M4 setup. Versions 1.4.9 through 1.5.1 use 135 lb for 2 × 8 without changing the two-round circuit. The September 3 workout remains an immutable v1.5.1 snapshot. Versions 1.5.3 through 1.5.7 use 145 lb for 2 × 8 while retaining the same circuit. Visible target loads are never prefilled as completed results.

The active primary program is **AFT Foundation Block 1 v1.5.7**, effective September 14, 2026, with service-worker cache **v50** and data schema 11. Version 1.5.7 changes only active Day 2: hand-release push-ups are 5 × 11 at RPE 6–8; seated lat pulldown is the next same-setup increment above 176 lb (approximately 187 displayed) for 3 × 8–10 at RPE 6–8 with every set capped at 10; seated dumbbell overhead press remains 30 lb per hand for 3 × 9 at RPE 7–9 until all three sets are completed cleanly; machine row is 110 displayed on the same confirmed setup for 3 × 9 at RPE 7–8; cable lateral raise is the next same-setup increment above 33 displayed per side (approximately 44) for 2 × 12–15 at RPE 7–8; pec deck is the next same-setup increment above 77 displayed (approximately 88) for 2 × 10–12 at RPE 7–9; dead bug remains 3 × 10 each side; and easy cardio remains 25–30 minutes at conversational RPE 4–5 with no duration increase or make-up work. Standard Days 1, 3, and 4, global Stage 4, optional sessions, and rotation are unchanged.

The completed September 13 Day 2 workout remains immutable v1.5.6 history, including its saved prescription snapshot, results, RPE, pain, and notes; active v1.5.7 targets never rewrite it. Version 1.5.6 retired the v1.5.5 **Day 1 — Illness Recovery** definition and selector option without replacing it. The completed September 10 v1.5.5 session remains historical data backed by its immutable snapshot and `rotationDayKey: day1`, so it continues to load, edit, export, sync, and count as primary. September 3 and September 5 remain immutable v1.5.1 and v1.5.3 history, any v1.5.4 workout remains immutable, and version 1.5.2 was never installed or synthesized in the public app.
...
New workouts use the device-local calendar date and default to the day following the most recent saved rotation-advancing primary session. No illness-recovery definition or coach-directed-alternatives group is active in v1.5.7. The saved September 10 historical session still maps to Day 1 and the saved September 13 Day 2 session advances the next default to Day 3, while optional recovery and skill-microdose sessions remain non-advancing. The **New Workout** action returns to the suggested standard primary day without affecting saved history.

The separately versioned **AFT Skill Microdose v1.0** is available at most once per Monday–Sunday week under normal use. It adds low-fatigue hand-release push-up and front-plank practice without advancing the primary rotation or changing the coach-directed run stage. It is the sole optional extra push-up/plank practice in program v1.5.7; historical v1.3 Day 3 skill bundles continue to retain their original weekly-dose behavior. Completed microdose reps and front-plank seconds count only as AFT-event practice volume, never as benchmark results.

Run progression is coach-directed rather than automatically advanced. Program v1.5.7 holds Stage 4—one minute walking followed by two minutes thirty seconds running for six rounds, totaling 21 programmed minutes—on standard Days 1 and 4. The post-strength Day 1 run starts around 5.5–5.6 mph and may move toward 5.7–5.8 only while RPE remains at or below 6. The fresh-leg Day 4 run starts around 5.7–5.8 mph and may move toward 5.9–6.0 only if RPE is at or below 5 through round 3; reduce toward 5.5 if RPE exceeds 6. Both prioritize duration and reserve over speed or average pace. Stage 4 does not advance until two pain-free completions under this guidance land at RPE 5–6, including one fresh Day 4 without a late forced slowdown. The retired historical illness-recovery snapshot contains no run. The timer starts every interval round with walking, automatically logs completed rounds and programmed interval time, and marks the run exercise done. Total elapsed time remains a separate user-entered value and is not used to judge structured interval adherence.
...
The full standard Day 1 walk/run interval block remains after the primary strength work because it is conditioning, not the warm-up. Active standard Days 1–4 display a separate warm-up. The retired September 10 snapshot preserves its own return-to-exercise check for historical rendering only. Day 4 starts with its primary run after its warm-up, and every walk/run timer begins with the walk segment before progressing to the run segment.
