...
- A Monday–Sunday skill-dose rule with the standalone microdose as the sole optional extra in program v1.4.3 while historical v1.3 Day 3 bundles remain compatible
...
Historical version 1.3 snapshots retain the original four-component circuit and any saved one-occurrence sled directive. Versions 1.4 through 1.4.3 use a 115 lb total Romanian-deadlift target for 2 × 8 and the sled-enhanced six-component circuit as their baseline. Visible target loads are never prefilled as completed results.

The active primary program is **AFT Foundation Block 1 v1.4.3**, effective August 18, 2026. Day 1 advances the trap-bar deadlift to 155 lb for 3 × 5, leg press to 140 lb for 3 × 9 on the same machine, dumbbell bench press to 35 lb per hand for 3 × 10, seated cable row to 88 lb for 3 × 11, and front plank to 3 × 45 seconds. The EZ-bar preacher curl holds 40 lb within the existing 2 × 10–15 range, and the same-setup cable pressdown targets 77 lb for 2 × 15 without treating that stack value as universal. Days 2–4, the skill microdose, and the two-round Day 3 circuit remain unchanged from v1.4.2.
