...
- A Monday–Sunday skill-dose rule with the standalone microdose as the sole optional extra in program v1.5.4 while historical v1.3 Day 3 bundles remain compatible
...
Historical version 1.3 snapshots retain the original four-component circuit and any saved one-occurrence sled directive. Versions 1.4 through 1.4.4 use a 115 lb total Romanian-deadlift target for 2 × 8 and the original sled-enhanced `foundation-1.4` circuit. Versions 1.4.5 through 1.4.8 use 125 lb for 2 × 8 and a separately versioned circuit template for the known M4 setup. Versions 1.4.9 through 1.5.1 use 135 lb for 2 × 8 without changing the two-round circuit. The September 3 workout remains an immutable v1.5.1 snapshot. Versions 1.5.3 and 1.5.4 use 145 lb for 2 × 8 while retaining the same circuit. Visible target loads are never prefilled as completed results.

The active primary program is **AFT Foundation Block 1 v1.5.4**, effective September 6, 2026. The Stage 4 structure remains 1:00 walking / 2:30 running × 6. The post-strength Day 1 run now begins around 5.5–5.6 mph and may move toward 5.7–5.8 only at RPE 6 or below. The fresh Day 4 run begins around 5.7–5.8 mph, may move toward 5.9–6.0 only if RPE is 5 or below through round 3, and reduces toward 5.5 if RPE exceeds 6. Day 4 front plank advances to 3 × 50 seconds with clean position required. Every other Day 1–4 prescription, optional recovery, the four-day rotation, the two-round conditioning circuit, and the skill microdose remain unchanged. The September 5 workout remains immutable v1.5.3 history, and version 1.5.2 was never installed in the public app.
...
The separately versioned **AFT Skill Microdose v1.0** is available at most once per Monday–Sunday week under normal use. It adds low-fatigue hand-release push-up and front-plank practice without advancing the primary rotation or changing the coach-directed run stage. It is the sole optional extra push-up/plank practice in program v1.5.4; historical v1.3 Day 3 skill bundles continue to retain their original weekly-dose behavior. Completed microdose reps and front-plank seconds count only as AFT-event practice volume, never as benchmark results.

Run progression is coach-directed rather than automatically advanced. Program v1.5.4 holds Stage 4—one minute walking followed by two minutes thirty seconds running for six rounds, totaling 21 programmed minutes—on Days 1 and 4. The post-strength Day 1 run starts around 5.5–5.6 mph and may move toward 5.7–5.8 only while RPE remains at or below 6. The fresh-leg Day 4 run starts around 5.7–5.8 mph and may move toward 5.9–6.0 only if RPE is at or below 5 through round 3; reduce toward 5.5 if RPE exceeds 6. Both prioritize duration and reserve over speed or average pace. Stage 4 does not advance until two pain-free completions under this guidance land at RPE 5–6, including one fresh Day 4 without a late forced slowdown. The timer starts every interval round with walking, automatically logs completed rounds and programmed interval time, and marks the run exercise done. Total elapsed time remains a separate user-entered value and is not used to judge structured interval adherence.
