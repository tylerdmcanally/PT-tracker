...
- A Monday–Sunday skill-dose rule with the standalone microdose as the sole optional extra in program v1.5.0 while historical v1.3 Day 3 bundles remain compatible
...
The active primary program is **AFT Foundation Block 1 v1.5.0**, effective August 29, 2026. Day 4 retains Stage 4 while refining the fresh-session treadmill cue to start around 6.1–6.2 mph and move toward 6.3–6.4 mph only while RPE remains at or below 6 and stride stays relaxed and normal; hand-release push-ups advance to 4 × 9. Day 4 front plank and mobility, Days 1–3, the four-day rotation, Stage 4, the two-round conditioning circuit, and the skill microdose remain unchanged.
