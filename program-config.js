 ...
 sessions:{
  day1:{
   ...
   exercises:[
    ...
    {id:'squatOrLegPress',name:'Leg press',prescription:'140 lb for 3 × 10',type:'weighted',unit:'lb',sets:3,targetLoad:140,targetLoadVariation:'Leg press',variations:['Leg press','Lying leg press','Upright leg press','Plate-loaded leg press','Selectorized leg press','Other leg press'],defaultVariation:'Leg press',targetRpe:'7',coachingNotes:'Use 140 lb only on the same comparable leg-press machine and setup. Log other equipment as a substitution and keep all three sets controlled at approximately RPE 7.'},
  ...
  day3:{
   ...
   exercises:[
    {id:'romanianDeadlift',name:'Romanian deadlift',prescription:'135 lb total for 2 × 8',type:'weighted',unit:'lb',sets:2,targetLoad:135,targetLoadVariation:'Barbell',targetRpe:'6–8',variations:['Barbell','Dumbbells','Smith machine'],defaultVariation:'Barbell',barWeights:{'Barbell':45,'Smith machine':20},coachingNotes:'Hold 135 lb for confirmation. Use chalk if available, and do not let grip loss alter hinge technique. Maintain technically clean repetitions within the target effort range.'},
    {id:'squatPattern',name:'Goblet squat',prescription:'55 lb for 3 × 10',type:'weighted',unit:'lb',sets:3,targetLoad:55,targetLoadVariation:'Goblet squat',targetRpe:'7–8',variations:['Goblet squat','Front squat','Hack squat','Leg press'],defaultVariation:'Goblet squat',barWeights:{'Front squat':45},coachingNotes:'Keep the goblet-squat load fixed at 55 lb and complete three controlled sets of 10.'},
    {id:'inclinePress',name:'Incline dumbbell press',prescription:'35 lb per hand for 3 × 8',type:'weighted',unit:'lb per hand',sets:3,targetLoad:35,targetLoadVariation:'Incline dumbbell press',targetRpe:'7–8',variations:['Incline dumbbell press','Incline chest-press machine'],defaultVariation:'Incline dumbbell press',coachingNotes:'Use 35 lb per hand for three technically clean sets of 8 within the target effort range.'},
    {id:'oneArmRow',name:'One-arm dumbbell row',prescription:'45 lb for 3 × 12 each side',type:'weighted',unit:'lb',sets:3,targetLoad:45,targetLoadVariation:'One-arm dumbbell row',targetRpe:'6–8',variations:['One-arm dumbbell row','One-arm cable row'],defaultVariation:'One-arm dumbbell row'},
