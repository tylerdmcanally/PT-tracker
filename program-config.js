window.AFT_PROGRAM_CONFIG={
 ...
 sessions:{
  ...
  day2:{
   ...
   exercises:[
    {id:'handReleasePushups',name:'Hand-release push-ups',prescription:'5 × 8',type:'body',sets:5,targetRpe:'6–7',coachingNotes:'Keep all five sets equal and technically clean. Maintain strong whole-body bracing, stop before failure, and do not turn this into a maximal-set test.'},
    {id:'verticalPull',name:'Lat pulldown',prescription:'Approximately 154 lb displayed on the same seated machine for 3 × 8–10',type:'weighted',unit:'lb',sets:3,targetRpe:'6–8',variations:['Seated lat pulldown','Modified standing lat pulldown','Assisted pull-up','Band-assisted pull-up'],defaultVariation:'Seated lat pulldown',coachingNotes:'Use the next smallest machine increment above 143 lb; approximately 154 lb applies only if the same seated machine uses 11-lb increments. Do not carry the displayed stack number to a different cable or pulley setup. The August 18 seated result—not the August 11 modified-standing result—justifies this progression.'},
    {id:'overheadPress',name:'Seated dumbbell overhead press',prescription:'25 lb per hand for 3 × 10',type:'weighted',unit:'lb per hand',sets:3,targetLoad:25,targetLoadVariation:'Seated dumbbell press',targetRpe:'7–8',variations:['Seated dumbbell press','Standing dumbbell press','Machine shoulder press'],defaultVariation:'Seated dumbbell press',coachingNotes:'Keep 25 lb per hand and do not increase the dumbbell load yet.'},
    {id:'chestSupportedRow',name:'Machine row',prescription:'88 lb for 3 × 12 on the same machine/setup',type:'weighted',unit:'lb',sets:3,targetRpe:'7–8',variations:['Dumbbell row','Machine row','T-bar row'],defaultVariation:'Machine row',coachingNotes:'Use 88 lb only on the same machine and setup as the August 18 exposure. Consider a future load progression only after all three sets of 12 are completed cleanly.'},
    {id:'lateralRaise',name:'Cable lateral raise',prescription:'2 × 15 on the same comparable cable setup/load',type:'weighted',unit:'lb per side',sets:2,targetRpe:'7–8',variations:['Cable lateral raise','Cuffed-cable lateral raise','Machine lateral raise','Dumbbell lateral raise'],defaultVariation:'Cable lateral raise',variationUnits:{'Cable lateral raise':'lb per side','Cuffed-cable lateral raise':'lb per side','Machine lateral raise':'lb total','Dumbbell lateral raise':'lb per hand'},coachingNotes:'Repeat the pain-free August 18 cable setup and load; that setup displayed 33 lb per side. The displayed stack value is not a universal load target. Maintain pain-free technique.'},
    {id:'chestFly',name:'Cable fly / pec deck',prescription:'66 lb total for 2 × 15 on the same pec-deck setup',type:'weighted',unit:'lb per side',sets:2,targetRpe:'7–9',variations:['Pec deck / machine fly','Cable chest fly'],defaultVariation:'Pec deck / machine fly',variationUnits:{'Cable chest fly':'lb per side','Pec deck / machine fly':'lb total'},coachingNotes:'Use the same pec-deck machine and setup as the August 18 baseline. Keep the stretch and contraction controlled and stop with approximately 1–3 good repetitions in reserve. Do not increase load until both sets of 15 are completed cleanly in the target effort range.'},
