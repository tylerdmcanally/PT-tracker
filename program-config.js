 ...
 coachNoteOverlays:[
  {
   ...
   text:'Use a pain-free machine or cuffed-cable variation, or omit this exercise. Stop if discomfort increases.',
   reason:'Temporary coach-directed substitution away from the dumbbell variation.'
  },
  {
  ...
  },
  {
   ...
   text:'Next Day 3 only: keep exactly two rounds, use approximately 30 seconds of hard cardio, then complete one controlled backward sled drag and one controlled forward sled push per round. Use the same prior comparable sled setup when identifiable; do not race or intentionally increase the load.',
   reason:'Temporary coach-directed measurement exposure; progression remains manual.',
   circuitDirective:{
 ...
 legacySessions:{
  ...
  day2:{
   ...
   exercises:[
    ...
    {id:'easyCardio',name:'Easy cardio',prescription:'25–30 minutes',type:'cardio',modalities:['Bike','Elliptical','Rower','Incline walk','Other'],targetRpe:'4–5',coachingNotes:'Use conversational effort throughout. Hold the 25–30 minute duration and restore the intended aerobic effort only if illness symptoms remain absent. Do not increase duration or add make-up work.'}
   ]
  },
  day3:{
   key:'day3',
   ...
   exercises:[
    {id:'romanianDeadlift',name:'Romanian deadlift',prescription:'145 lb total for 2 × 8',type:'weighted',unit:'lb',sets:2,targetLoad:145,targetLoadVariation:'Barbell',targetRpe:'6–8',variations:['Barbell','Dumbbells','Smith machine'],defaultVariation:'Barbell',barWeights:{'Barbell':45,'Smith machine':20},coachingNotes:'Hold 145 lb for confirmation. Use chalk if available, do not let grip loss alter hinge technique, and do not progress again without a successful confirmation at this load. Maintain technically clean repetitions within the target effort range.'},
    {id:'squatPattern',name:'Goblet squat',prescription:'55 lb for 3 × 10',type:'weighted',unit:'lb',sets:3,targetLoad:55,targetLoadVariation:'Goblet squat',targetRpe:'7–8',variations:['Goblet squat','Front squat','Hack squat','Leg press'],defaultVariation:'Goblet squat',barWeights:{'Front squat':45},coachingNotes:'Keep the goblet-squat load fixed at 55 lb and complete three controlled sets of 10. Do not increase it while pre-circuit leg fatigue remains the constraint.'},
    {id:'inclinePress',name:'Incline dumbbell press',prescription:'35 lb per hand for 3 × 9',type:'weighted',unit:'lb per hand',sets:3,targetLoad:35,targetLoadVariation:'Incline dumbbell press',targetRpe:'7–8',variations:['Incline dumbbell press','Incline chest-press machine'],defaultVariation:'Incline dumbbell press',coachingNotes:'Use 35 lb per hand for three technically clean sets of 9 within the target effort range.'},
    {id:'oneArmRow',name:'One-arm dumbbell row',prescription:'50 lb for 3 × 8–10 each side',type:'weighted',unit:'lb',sets:3,targetLoad:50,targetLoadVariation:'One-arm dumbbell row',targetRpe:'6–8',variations:['One-arm dumbbell row','One-arm cable row'],defaultVariation:'One-arm dumbbell row',coachingNotes:'Use the next standard dumbbell increment and keep every repetition clean on both sides.'},
    {id:'singleLegStrength',name:'Split squat',prescription:'Body weight for 2 × 12 each leg',type:'weighted',unit:'lb total',sets:2,targetRpe:'5–7',variations:['Body-weight split squat','Light dumbbell split squat','Forward step-up','Lateral step-up'],defaultVariation:'Body-weight split squat',coachingNotes:'Use body weight and controlled repetitions for both sets. Do not add load before the conditioning circuit.'},
  ...
  day4:{
   ...
   exercises:[
    {id:'primaryRun',name:'Walk / run intervals',prescription:'Stage 4 — 1:00 walk / 2:30 run × 6',type:'run',runStage:4,targetRpe:'5–6',coachingNotes:'On a treadmill, start the running segments around 5.7–5.8 mph and hold that range through at least the first three rounds. Move toward 5.9–6.0 mph only if RPE is at or below 5 through round 3 and stride and breathing remain relaxed. Reduce toward 5.5 mph if RPE exceeds 6. Prioritize completion with reserve; duration progression takes priority over speed progression or calculated pace. Do not advance beyond Stage 4 until two pain-free Stage 4 completions under this guidance land at RPE 5–6, including one fresh Day 4 without a late forced slowdown. Record actual walk and run speeds in the existing run details.'},
 ...
 sessions:{
  strengthUpperAft:{
   ...
   exercises:[
    {id:'handReleasePushups',name:'Hand-release push-ups',prescription:'5 × 11',type:'body',sets:5,targetRpe:'6–8',coachingNotes:'Keep all five sets equal, technically clean, and submaximal. Maintain strong whole-body bracing, stop before failure, and do not turn any set into a maximal test.'},
    {id:'verticalPull',name:'Lat pulldown',prescription:'Next smallest increment above 176 lb on the same seated machine (approximately 187 lb displayed if it uses 11-lb increments) for 3 × 8–10',type:'weighted',unit:'lb',sets:3,targetRpe:'6–8',variations:['Seated lat pulldown','Modified standing lat pulldown','Assisted pull-up','Band-assisted pull-up'],defaultVariation:'Seated lat pulldown',coachingNotes:'Use the next smallest machine increment above 176 lb only on the same seated machine and setup. Approximately 187 lb is guidance for an 11-lb stack increment, not a universal target for a different cable or pulley setup. Cap every set at 10 repetitions.'},
    {id:'overheadPress',name:'Seated dumbbell overhead press',prescription:'25 lb per hand for 3 × 8–10',type:'weighted',unit:'lb per hand',sets:3,targetLoad:25,targetLoadVariation:'Seated dumbbell press',targetRpe:'7–8',variations:['Seated dumbbell press','Standing dumbbell press','Machine shoulder press'],defaultVariation:'Seated dumbbell press',coachingNotes:'Use controlled, technically clean, submaximal repetitions. Cap each set at 10. Do not add make-up repetitions or train to failure. Do not return to 30 lb per hand until all three sets of 10 are completed cleanly at no more than RPE 8 and a later coach-directed program version authorizes the increase.'},
    {id:'chestSupportedRow',name:'Machine row',prescription:'110 lb displayed on the same confirmed machine/setup for 3 × 9',type:'weighted',unit:'lb',sets:3,targetRpe:'7–8',variations:['Dumbbell row','Machine row','T-bar row'],defaultVariation:'Machine row',coachingNotes:'Progress repetitions at 110 lb displayed only on the same confirmed machine and setup. Do not treat 110 lb as comparable on another machine.'},
    {id:'lateralRaise',name:'Cable lateral raise',prescription:'Next smallest comparable increment above 33 lb displayed per side on the same pain-free cable setup (approximately 44 lb if applicable) for 2 × 12–15',type:'weighted',unit:'lb per side',sets:2,targetRpe:'7–8',variations:['Cable lateral raise','Cuffed-cable lateral raise','Machine lateral raise','Dumbbell lateral raise'],defaultVariation:'Cable lateral raise',variationUnits:{'Cable lateral raise':'lb per side','Cuffed-cable lateral raise':'lb per side','Machine lateral raise':'lb total','Dumbbell lateral raise':'lb per hand'},coachingNotes:'Use the next smallest comparable increment above 33 lb displayed per side only on the same pain-free cable setup. Approximately 44 lb is setup-specific guidance, not a universal target. Maintain pain-free technique.'},
    {id:'chestFly',name:'Cable fly / pec deck',prescription:'Next smallest comparable increment above 77 lb displayed on the same pec-deck machine/setup (approximately 88 lb if applicable) for 2 × 10–12',type:'weighted',unit:'lb per side',sets:2,targetRpe:'7–9',variations:['Pec deck / machine fly','Cable chest fly'],defaultVariation:'Pec deck / machine fly',variationUnits:{'Cable chest fly':'lb per side','Pec deck / machine fly':'lb total'},coachingNotes:'Use the next smallest comparable increment above 77 lb displayed only on the same pec-deck machine and setup. Approximately 88 lb is setup-specific guidance. Keep the stretch and contraction controlled and stop with approximately 1–3 good repetitions in reserve.'},
    {id:'trunkStability',name:'Dead bug or Pallof press',prescription:'3 × 10 each side',type:'body',sets:3,variations:['Dead bug','Pallof press'],defaultVariation:'Dead bug',coachingNotes:'Keep the movement slow and controlled. Use a full exhale and deliberate brace rather than increasing repetitions because the current variation feels easy.'},
